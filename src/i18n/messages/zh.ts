...
const zh: Messages = {
  ...
  home: {
    ...
    heroSubtitle:
      "一个用真实撮合引擎驱动的碳市场模拟盘 — 以 $100,000 演示资金练习标准化现货与 OTC 大宗交易。不涉及真实资金,也不涉及真实碳资产。",
    startTrading: "开始交易",
    browseOtc: "浏览 OTC 挂牌 →",
    spotMarket: "现货行情",
  ...
  login: {
    ...
    noAccount: "还没有账号？",
    signUp: "注册",
    tryDemo: "免注册试玩 — 一键演示账号",
    tryDemoHint: "生成一个一次性账号，自带 $100,000 演示资金，无需邮箱。",
    demoStarting: "正在准备演示账号…",
  },
  ...
  rating: {
    ...
    title: "碳信用评级鉴赏家",
    lead:
      "Carbadia 的碳信用质量评估演示 — 采用真实评级机构使用的四个维度,从 AAA 到 D 八档等级。页面所示评级均为示例。",
    ...
    ctaTitle: "带着质量视角,去练习",
    ctaSub: "带上这四个质量维度,去模拟盘的订单簿和 OTC 市场里走一圈。",
    ctaLink: "前往交易所 →",
  },
  ...
  footer: {
    ...
    disclaimer:
      "模拟演示平台。Carbadia 不持有任何金融牌照,不进行真实交易、清算或结算;站内所有标的、行情与市场数据均为虚构,仅供演示,不涉及任何真实资金或碳资产。本站内容不构成任何投资、财务或法律建议,交易有风险。Verra、Gold Standard、UNFCCC、CCER 等标准与登记簿名称仅作演示引用;Carbadia 与上述任何机构均无关联,亦未获其背书。",
  },

  feedback: {
    title: "反馈",
    intro: "发现 bug?哪里让你困惑?说给我们听 — 每一条都会看。",
    placeholder: "发生了什么 / 你期望是什么?",
    contactLabel: "邮箱或联系方式(选填,便于回复)",
    submit: "发送",
    sending: "发送中…",
    thanks: "收到,谢谢!",
  },
